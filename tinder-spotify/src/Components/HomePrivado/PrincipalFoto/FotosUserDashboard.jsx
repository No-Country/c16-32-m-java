...
import fondo1 from '../../../assets/selec1.png';
import fondo2 from '../../../assets/selec2.png';
import fondo3 from '../../../assets/selec3.png';
import fondo4 from '../../../assets/selec4.png';

const fotos = [fondo1, fondo2, fondo3, fondo4];

const FotosUserDashboard = ({ onNextClick }) => {
...
export default FotosUserDashboard;
